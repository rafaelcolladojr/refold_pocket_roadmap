...
class ArticleSectionModel extends ArticleSection {
  const ArticleSectionModel({
    required String id,
    required String title,
    required List<ArticleModel> articles,
  }) : super(id: id, title: title, articles: articles);

  factory ArticleSectionModel.fromJson(Map<String, dynamic> json) => ArticleSectionModel(
        id: json["id"],
        title: json["title"],
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "title": title,
        "articles": List<ArticleModel>.from(articles.map((x) => (x as ArticleModel).toJson())),
      };
